...
client.sendMessage(media);
  ...
  const media = MessageMedia.fromFilePath('mp4/ff.jpg');
    ...
    console.log(`stdout: ${stdout}`);
	 ...
	 msg.reply("Permintaan sedang diproses*Jangan spam ya*")
  ...
  const media = MessageMedia.fromFilePath('mp4/glow.jpg');
   ...
   msg.reply("Permintaan sedang diproses*Jangan di Spam ya*")
...
YD.on("error", function(error) {
	...
	msg.reply('*Harap Patuhi Rules* | HR Bot');
